...
| `iterate-design` | Adversarial review | Catch coherence issues self-review misses | 5 topics (vision, experience, world, governance, scope) + Design Identity Check + Design Choice Examination. External LLM reviewer |
